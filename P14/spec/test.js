...
describe("pokemonager", () => {
  describe("findNames", () => {
    it("should return an array of names of all Pokemon", () => {
      ...
      const expected = [];
      for (individual of allPokemon) expected.push(individual.Name);
  ...
  describe("findByResistance", () => {
    it("should find pokemon based by resistance", () => {
      ...
      for (individual of allPokemon)
        if (individual.Resistant.includes("Fire")) expected.push(individual);
      ...
      expect(
        actual,
        "findByResistance() to filter based on resistance to Fire"
  ...
  describe("avgMaxCP", () => {
    it("should return the average maxCP of all Pokemon", () => {
      ...
      Array.prototype.reduce = function() {
        reduceCalled = true;
        return realReduce.apply(this, arguments);
      };
